...
def lRoman():
    ...
    cap = cv2.VideoCapture("Resources/left_leg_roman_deadlift.mp4")

    detector = pm.PoseDetector()

    error_keeper = [1 for i in range(10)]
    count = 0  # CHANGE THESE ====================================
    max_count = 2  # CHANGE THESE =====================================
    rep_count_locked = 1
    ...
    while True:
        ...
        if len(lmList) != 0:
            ...
            #print("13: ", angle_13_a, " 14: ", angle_14_a)
            ...
            angle_23_a = detector.findAngle(img, 11, 23, 25, 1)

            angle_24_a = detector.findAngle(img, 12, 24, 26, 1)
            ...
            if count < max_count:
                if   (   (angle_23_a < 200 and angle_23_a > 160) and (angle_24_a < 200 and angle_24_a > 160)  and (angle_26_a < 163 and angle_26_a > 155)  ):
                ...
                elif (   (angle_23_a < 310 and angle_23_a > 270) and (angle_24_a < 195 and angle_24_a > 184)  and (angle_26_a < 175 and angle_26_a > 149) and (rep_count_locked == 0) ):
                    cv2.putText(img, "Final State", (10, 25), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 2)
                    #print("angle_23_a:", angle_23_a, "angle_24_a:", angle_24_a, " angle_26_a:", angle_26_a)
                    if rep_count_locked == 0:
                        ...
                        pass
            '''
                elif (  (angle_123 > 123 and angle_26_a < 123)   and (angle_25_a > 58 and angle_25_a < 168)  and (rep_count_locked == 0) ):
            ...
            if (rep_count_locked == 0 and count < max_count):
                ...
                check_angle_error(angle_13_a, '<', 180, 0, "ERROR: Your left arm is bent too much")
                check_angle_error(angle_13_a, '>', 186, 1, "ERROR: Your left arm is too straight")

                check_angle_error(angle_14_a, '<', 176, 2, "ERROR: Your right arm is bent too much")
                check_angle_error(angle_14_a, '>', 187, 3, "ERROR: Your right arm is too straight")

                check_angle_error(angle_23_a, '<', 160, 4, "ERROR: Your left hip is bent too much")
                check_angle_error(angle_23_a, '>', 310, 5, "ERROR: Your left hip is too straight")

                check_angle_error(angle_24_a, '<', 160, 6, "ERROR: Your right hip is bent too much")
                check_angle_error(angle_24_a, '>', 200, 7, "ERROR: Your right hip is too straight")

                check_angle_error(angle_26_a, '<', 149, 8, "ERROR: Your right knee is bent too much")
                check_angle_error(angle_26_a, '>', 175, 9, "ERROR: Your right knee is too straight")
