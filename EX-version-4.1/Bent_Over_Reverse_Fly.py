...
def bentOver():
    ...
    print("running bent_over_reverse_fly.py")

    # "Resources/man_performing_bicep_curls_micro.mp4"
    cap = cv2.VideoCapture("Resources/bent_over_reverse_fly.mp4")

    detector = pm.PoseDetector()

    error_keeper = [1 for i in range(10)]
    count = 0  # CHANGE THESE ====================================
    max_count = 4.5  # CHANGE THESE =====================================
    rep_count_locked = 1
    ...
    error_report = arr.reshape(12, 3)  # MIGHT HAVE TO CHANGE THESE ACC. TO THE NUMBER OF POSSIBLE ERRORS IN EXERCISE
    #  //
    ...
    while True:
        ...
        if len(lmList) != 0:
            # cv2.rectangle(img, (0, 0), (210, 70), (255, 255, 255), -1) #use this if reps not clearly visible
            ...
            angle_13_a = detector.findAngle(img, 11, 13, 15, 1)
            ...
            angle_27_a = detector.findAngle(img, 25, 27, 31, 0)
            # angle_27_b = detector.findAngle(img, 25, 27, 29, 1)

            angle_28_a = detector.findAngle(img, 26, 28, 32, 0)
            ...
            if count < max_count:
                if   (   (angle_11_a < 120 and angle_11_a > 105) and (angle_12_a < 252 and angle_12_a > 242) and (angle_13_a < 150 and angle_13_a > 132) and (angle_14_a < 213 and angle_14_a > 205) ):
                    cv2.putText(img, "Initial State", (0, 25), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 2)
                    #print(angle_14_a)
                    rep_count_locked = 0
                    if dir == 1:
                        count += 0.5
                ...
                elif (   (angle_11_a < 176 and angle_11_a > 168) and (angle_12_a < 180 and angle_12_a > 168) and (angle_13_a < 160 and angle_13_a > 145) and (angle_14_a < 232 and angle_14_a > 216)  and (rep_count_locked == 0) ):
                    cv2.putText(img, "Final State", (0, 25), cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 2)
                # print("angle_11_a:", angle_11_a, "angle_12_a:", angle_12_a, " angle_13_a:", angle_13_a, " angle_14_a:", angle_14_a)
                    if rep_count_locked == 0:
                        ...
                        pass
                if (rep_count_locked == 0):
                    print("angle_23_a:", angle_23_a, "angle_24_a:", angle_24_a, " angle_25_a:", angle_25_a, " angle_26_a:",
                        angle_26_a, "angle_27_a:", angle_27_a, "angle_28_a:", angle_28_a, "count: ", count)

            #  elif (  (angle_13_a < 135 and angle_13_a > 140) and ( (angle_14_a < 208 and angle_14_a > 214)  and (rep_count_locked == 0)) ):
            ...
            if (rep_count_locked == 0 and count < max_count):
                ...
                check_angle_error(angle_23_a, '<', 198, 0, "ERROR: Your left hip is bent too much")
                check_angle_error(angle_23_a, '>', 228, 1, "ERROR: Your left hip is too straight")

                check_angle_error(angle_24_a, '<', 142, 2, "ERROR: Your right hip is bent too much")
                check_angle_error(angle_24_a, '>', 164, 3, "ERROR: Your right hip is too straight")

                check_angle_error(angle_25_a, '<', 165, 4, "ERROR: Your left knee is bent too much")
                check_angle_error(angle_25_a, '>', 185, 5, "ERROR: Your left knee is too straight")

                check_angle_error(angle_26_a, '<', 184, 6, "ERROR: Your right knee is bent too much")
                check_angle_error(angle_26_a, '>', 188, 7, "ERROR: Your right knee is too straight")

                check_angle_error(angle_27_a, '<', 180, 8, "ERROR: Your left ankle is bent too much")
                check_angle_error(angle_27_a, '>', 235, 9, "ERROR: Your left ankle is too straight")

                check_angle_error(angle_28_a, '<', 175, 10, "ERROR: Your right ankle is bent too much")
                check_angle_error(angle_28_a, '>', 185, 11, "ERROR: Your right ankle is too straight")
    ...
    workbook = xlsxwriter.Workbook('Exercise_Reports/Crunches_error_report.xlsx')  # Change file name acc. to exercise
